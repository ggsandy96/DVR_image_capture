...
def capture():
	...
	if(state==1):
		...
		cmd_instant  = "ffmpeg -rtsp_transport tcp -y -i rtsp://admin:admin@192.168.1.12 -vframes 1 -vcodec png /home/linaro/user/camera/cam2/cam2_"+year+"_"+month+"_"+day+"_"+hour+"_"+minute+"_"+second+".png"
		print cmd_instant
		...
		split = fline.index('/')
        	path=fline[split+1:]
	        url = fline[:split]
		cmd_upload_instant="lftp -u sandeep,aia@123 -e 'cd " + path + ";cd cam2;put /home/linaro/user/camera/cam2/cam2_"+year+"_"+month+"_"+day+"_"+hour+"_"+minute+"_"+second+".png;exit' " + url + " &"
		os.system(cmd_upload_instant)
	else:
		os.system("sudo /home/linaro/App/cameraapp/high.sh")
		time.sleep(10)
		count=0
		status = os.system("ping -c 1 192.168.1.12")
		while (status!=0):
			status = os.system("ping -c 1 192.168.1.12")
			time.sleep(5)
			count = count+1
...
def signal_handler2(signal, frame):
	...
	if(state==1):
		...
		cmd_instant  = "ffmpeg -rtsp_transport tcp -y -i rtsp://admin:admin@192.168.1.12 -vframes 1 -vcodec png /home/linaro/user/camera/cam2/cam2_"+year+"_"+month+"_"+day+"_"+hour+"_"+minute+"_"+second+".png"
                ...
                cmd_upload_instant="lftp -u sandeep,aia@123 -e 'cd " + path + ";cd cam2;put /home/linaro/user/camera/cam2/cam2_"+year+"_"+month+"_"+day+"_"+hour+"_"+minute+"_"+second+".png;exit' " + url + " &"
                os.system(cmd_upload_instant)
                cmd_trans= "cp /home/linaro/user/camera/cam2/cam2_"+year+"_"+month+"_"+day+"_"+hour+"_"+minute+"_"+second+".png /home/linaro/user/camera/cam2/event/"
                os.system(cmd_trans)
	os.system("sudo /home/linaro/App/cameraapp/low.sh")
...
def read():
        f1 = file('/home/linaro/user/camera/cam2/cam2.csv', 'r')
        c1 = csv.reader(f1)
        return c1
...
def delete(str):
	...
	print old
	rem = "find /home/linaro/user/camera/cam2 -type f -mtime +" +old+ " -name '*.png' -exec rm -rf {} \;"
	os.system(rem)
...
try:
	...
	try:
		os.system("cp /home/linaro/user/camera/cam2/cam2.bak /home/linaro/user/camera/cam2/cam2.csv")
        	c1= read()
        	c1=list(c1)
        	arr1 = np.asarray(c1)
        	arr1 = arr1.astype(int)
...
print arr1
while(1):
	if (os.path.isfile("/home/linaro/user/camera/cam2/cam2_new.csv") == True ):
		out = subprocess.check_output("ps aux | grep ftpd", shell=True)
		if 'cam2_new.csv' in out:
       			print "csv file is being uploaded"
		else:
		       	print "cam2_csv upload complete"
			try:
				os.system("mv /home/linaro/user/camera/cam2/cam2.csv /home/linaro/user/camera/cam2/cam2.bak")
	                        os.system("mv /home/linaro/user/camera/cam2/cam2_new.csv /home/linaro/user/camera/cam2/cam2.csv")
				c1= read()
                        	c1=list(c1)
                	        arr1 = np.asarray(c1)
        	                arr1 = arr1.astype(int)
